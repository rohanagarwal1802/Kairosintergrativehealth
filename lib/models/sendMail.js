...
// const CLIENT_ID = process.env.CLIENT_ID.trim();; // Replace with your Azure AD Client ID
// const CLIENT_SECRET =  process.env.CLIENT_SECRET.trim();; // Replace with your Client Secret
// const TENANT_ID = process.env.TENANT_ID.trim();; // Replace with your Tenant ID
