...
const { getAppointmentByPatientId } = require('./appointmentOperations');
...
await fs.writeFile(filePath, JSON.stringify(filteredPatients, null, 2), 'utf8');
  ...
  console.log("sdkhsjk",email,password)
      if (!patientByEmail) {
        return "Patient Not Found";
      }

      if(!patientByEmail.password){
        return "Please check email and create your password";
      }
